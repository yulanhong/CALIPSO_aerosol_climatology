...
pro plot_lidlayer_phase
print,systime()
   lidfname=file_search('/u/sciteam/yulanh/mydata/radar-lidar_out/CAL_ACLAY/Parallel_1','*transparent.hdf')
;   lidfname=file_search('/u/sciteam/yulanh/mydata/radar-lidar_out/CAL_ACLAY/Parallel_1','*2006*')
   ...
   aero_flag=0
   aerocldflag='global_noaerosol_transparent_'
...
;   maxlon=135	
   ...
   Taero_only_numv=Ulonarr(dimx,dimy,dimh,Nmon)
...
;	mon=strmid(fname,5,2,/rev)
	...
	If monind ge 5 and monind le 10 Then Begin
;	print,monind
	...
	IF (aero_flag eq 0) then begin
  	...
  	Ticenumh[*,*,ind]=Ticenumh[*,*,ind]+icenumh
   	...
   	Tobsnumv[*,*,*,ind]=Tobsnumv[*,*,*,ind]+obsnumv
  	Ticenumv[*,*,*,ind]=Ticenumv[*,*,*,ind]+icenumv
   	Twatnumv[*,*,*,ind]=Twatnumv[*,*,*,ind]+watnumv
   	Tuncernumv[*,*,*,ind]=Tuncernumv[*,*,*,ind]+uncernumv
   	Ticewatnumv[*,*,*,ind]=Ticewatnumv[*,*,*,ind]+icewatnumv
   	Ticeuncernumv[*,*,*,ind]=Ticeuncernumv[*,*,*,ind]+iceuncernumv
   	Twatuncernumv[*,*,*,ind]=Twatuncernumv[*,*,*,ind]+watuncernumv
   	Tlowconfnumv[*,*,*,ind]= Tlowconfnumv[*,*,*,ind] + lowconfnumv
	EndIf
	...
	IF (aero_flag eq 1) then begin
  	...
  	Ticenumh[*,*,ind]=Ticenumh[*,*,ind]+aeroicenumh
   	...
   	Tobsnumv[*,*,*,ind]=Tobsnumv[*,*,*,ind]+obsnumv
  	Ticenumv[*,*,*,ind]=Ticenumv[*,*,*,ind]+aeroicenumv
   	Twatnumv[*,*,*,ind]=Twatnumv[*,*,*,ind]+aerowatnumv
   	Tuncernumv[*,*,*,ind]=Tuncernumv[*,*,*,ind]+aerouncernumv
   	Ticewatnumv[*,*,*,ind]=Ticewatnumv[*,*,*,ind]+aeroicewatnumv
   	Ticeuncernumv[*,*,*,ind]=Ticeuncernumv[*,*,*,ind]+aeroiceuncernumv
   	Twatuncernumv[*,*,*,ind]=Twatuncernumv[*,*,*,ind]+aerowatuncernumv

   	Taero_only_numh[*,*,ind] = Taero_only_numh[*,*,ind]+ aero_only_numh
   	Taero_only_numv[*,*,*,ind] = Taero_only_numv[*,*,*,ind] + aero_only_numv
