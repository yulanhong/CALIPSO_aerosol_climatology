...
;=== write the results ====
openw,u,region[k]+'_aersol_tau_timeseries.txt',/get_lun
printf,u,'time,all aerosol,cld aerosol,cloud-free, incld-aero, isolate-aero'
for i=0, n_elements(month)-1 do printf,u,month[i],aero_all_tau_series[i],aero_cld_tau_series[i],$
	aero_only_tau_series[i],aero_incld_tau_series[i],aero_isolate_tau_series[i]
free_lun,u
...
fontsz=9.
fonttk=1.2
margin=[0.12,0.2,0.03,0.1]
symsz=0.5
otyrange1=[0.1 ,0.0,0.05, 0.1,0.0 ,0.05, 0.1, 0.0,0.0,0.0] 
otyrange2=[0.2,0.2,0.3 , 0.5,0.6 ,0.25,0.70, 0.5,0.3,0.5]
...
aero_cld_fre_series1[0:108]=aero_cld_tau_series[0:108]
aero_cld_fre_series1[109]=!values.f_nan
aero_cld_fre_series1[110:n]=aero_cld_tau_series[109:n-1]

aero_all_fre_series1[0:108]=aero_all_tau_series[0:108]
aero_all_fre_series1[109]=!values.f_nan
aero_all_fre_series1[110:n]=aero_all_tau_series[109:n-1]

aero_incld_fre_series1[0:108]=aero_incld_tau_series[0:108]
aero_incld_fre_series1[109]=!values.f_nan
aero_incld_fre_series1[110:n]=aero_incld_tau_series[109:n-1]

aero_isolate_fre_series1[0:108]=aero_isolate_tau_series[0:108]
aero_isolate_fre_series1[109]=!values.f_nan
aero_isolate_fre_series1[110:n]=aero_isolate_tau_series[109:n-1]


aero_only_fre_series1[0:108]=aero_only_tau_series[0:108]
aero_only_fre_series1[109]=!values.f_nan
aero_only_fre_series1[110:n]=aero_only_tau_series[109:n-1]
...
if k eq 0 then begin	
  ...
  p0=plot(x,aero_cld_fre_series1,dim=[900,820],color=pcolor,name='Cloudy aerosol',layout=[2,Nr,k+1],$
	ytitle='Aerosol optical depth',xtitle='Time(yymm)',xtickname=xname,xtickvalues=xvalue,margin=margin,$
  ...
  pf=plot(x,aero_cld_fre_series1,color=pcolor,name='Cloudy aerosol',layout=[2,Nr,k+1],$
	ytitle='Aerosol optical depth',xtitle='Time(yymm)',xtickname=xname,xtickvalues=xvalue,/current,margin=margin,$
...
p0.save,'regional_seasonal_aerosol_aod.png'
;======
endfor
